...
# line graph % winning
ggplot(df, aes(x=worst_white_eval_bucket)) + geom_line(stat="summary", fun.y="")
...
ggplot(t, aes(x=Worst_Eval, y=White_Wins, group=1)) + geom_line() + ylim(0,1)
ggplot(t, aes(x=Worst_Eval, y=White_Wins, group=Time_Control)) + geom_line() + ylim(0,1)
